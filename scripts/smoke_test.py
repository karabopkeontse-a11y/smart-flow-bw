...
required=['Smart Flow BW','Water intelligence with Thothi AI','Before Your Bill','Thothi','Overnight leak','High flow / burst risk','Usage improving','Evening spike','id="thothi"','id="overview"','id="alerts"','id="save"','id="devices"','id="sfDevicePanel"','Sign in / Sign up','data-action="prev"','data-action="next"','data-action="run"']
